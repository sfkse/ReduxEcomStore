                ...
                <animated.div style={props} className={`hamburger  ${showMenu ? 'd-flex' : 'd-none'}`}>
                    ...
                    <ul className="hamburger__menu">
                        <li className="hamburger__item" >
                            <Link to="/" className="hamburger__link" onClick={handleClick}>Home</Link>
                        </li>
                        <li className="hamburger__item" >
                            <a href="/contact" className="hamburger__link" onClick={handleClick}>Contact</a>
                        </li>
                    </ul>
